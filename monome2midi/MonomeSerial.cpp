...
class MonomeEventQueue {
    ...
    public:
        ...
        void add(uint8_t x, uint8_t y, uint8_t pressed) {
...
class MonomeSerial : public USBSerial {
    ...
    public: 
        ...
        MonomeEventQueue eventQueue;
    
        MonomeSerial(USBHost usbHost) : USBSerial(usbHost) {}
        ...
        void processSerial() {
            ...
            switch (identifierSent) {
                ...
                case 0x20:
                    ...
                    gridKeyX = read();
                    gridKeyY = read();
                    eventQueue.add(gridKeyX, gridKeyY, 0);
                ...
                case 0x21:
                    ...
                    gridKeyX = read();
                    gridKeyY = read();
                    eventQueue.add(gridKeyX, gridKeyY, 1);
